<template>
  <v-app class="appbg">
    ...
    <v-container>
      ...
      <v-row>
      <v-col cols='12' md='8'><Introduction/></v-col>
      <v-col cols='12' md='4'><Orbits/></v-col>
      </v-row>
    ...
    <v-img v-if="false" src="/src/assets/skills/postgres.png"></v-img>
...
//   methods: {
//     onScroll (event) {
//       var bgopacity = 1- window.scrollY / 700;
